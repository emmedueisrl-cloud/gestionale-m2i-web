...
CREATE TABLE `proroghe_contratti` (`id` integer not null primary key autoincrement, `dipendente_id` varchar(255), `scadenza_precedente` varchar(255), `nuova_scadenza` varchar(255), `note` varchar(255), `data_proroga` datetime default CURRENT_TIMESTAMP);
